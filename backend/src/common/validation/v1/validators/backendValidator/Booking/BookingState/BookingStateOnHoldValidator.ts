...
import { NullValidator, ModelValidator, ValidatorError } from '../../ValidatorHelpers';
...
export class BookingStateOnHoldValidator implements ModelValidator {
  ...
  public validate = (booking?: Booking): ValidatorError[] => {
    return [
      ...
      CommonValidator.validateUTCDateTime(`${this.path}.utcUpdatedAt`, booking?.utcUpdatedAt, { nullable: true }),
      CommonValidator.validateUTCDateTime(`${this.path}.utcExpiresAt`, booking?.utcExpiresAt, { nullable: true }),
